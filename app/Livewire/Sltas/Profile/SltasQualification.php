...
class SltasQualification extends Component
{
    ...
    public $sleas; // Pass sleas object to component
    ...
    public function save()
    {
        ...
        PeopleEducationQualification::create([
            'people_id' => $this->sleas->people_id,
    ...
    {
        $qualificationList = PeopleEducationQualification::where('active_status', '1')->where('people_id', $this->sleas->people_id)->get();
        return view('livewire.sltas.profile.sltas-qualification',compact('qualificationList'));
    }
}
