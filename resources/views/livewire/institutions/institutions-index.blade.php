                    ...
                    <td class="px-4 py-3 whitespace-nowrap">
                        <div class="flex items-center space-x-3">
                            <div class="flex-shrink-0 h-10 w-10">
                                <svg class="h-8 w-8 text-gray-400 dark:text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            <div>
                                <div class="text-sm font-medium text-slate-900 dark:text-slate-100">
                                    @can('view institutions profile overview')
                                        <flux:link href="{{ route('institutions.profile.overview', $institution->id) }}" variant="ghost">
                                            {{ $institution->name }}
                                        </flux:link>
                                    @else
                                        {{ $institution->name }}
