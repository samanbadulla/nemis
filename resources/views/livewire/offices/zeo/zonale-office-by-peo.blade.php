<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Zonal Education Office by') }} {{$province->short_name}} </flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Manage Zonal Education Office by provincial office') }}
        </flux:subheading>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="text-sm text-slate-600 dark:text-slate-100">No Zonal Education Office Found!</div>
                        </td>
                    </tr>
                @endforelse
            </tbody>
