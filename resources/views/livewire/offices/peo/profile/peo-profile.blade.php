<section class="w-full">
    ...
    <x-offices.peo.layout :officeid="$id">
        ...
        <div class="antialiased min-h-screen">
            ...
            <div class="max-w-5xl bg-white dark:bg-gray-800 p-6 rounded-b-lg">
                ...
                <div class="flex items-center space-x-4 mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                    <div
                        class="relative w-20 h-20 sm:w-24 sm:h-24 rounded-lg overflow-hidden border-2 {{ $provincialEducationOffice->active_status ? 'border-green-500' : 'border-red-500' }}">

                        @if ($provincialEducationOffice->logo)
                            <img src="{{ asset('storage/' . $provincialEducationOffice->logo) }}"
                                alt="{{ $provincialEducationOffice->name }}"
                                class="w-full h-full object-cover {{ $provincialEducationOffice->active_status ? '' : 'grayscale opacity-60' }}">
                            @unless ($provincialEducationOffice->active_status)
                                <div
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div
                                ...
                                <p class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                    {{ $provincialEducationOffice->workplace_id ?? 'N/A' }}
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
                            ...
                            <div
                                ...
                                <p class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                    {{ $provincialEducationOffice->address ?? 'N/A' }}
                                </p>
                            </div>
