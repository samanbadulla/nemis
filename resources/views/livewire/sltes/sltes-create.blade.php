    ...
    <div class="relative mb-6 w-full">
        ...
        <form wire:submit.prevent="save" class="mt-6 max-w-xl space-y-6">
            ...
            <div class="mt-6 max-w-xl space-y-6">
                ...
                <flux:field>
                    <flux:select label="Appointment category" wire:model.live="teacherCategory">
                        <option value="">Select</option>
                ...
                <flux:field>
                    <flux:select label="Appointed Potision" wire:model.live="appointedPotision">
                        <option value="">Select</option>
                        @foreach ($potisionOption as $potision)
                            <option value="{{ $potision->position_id }}">{{ $potision->position_name }}</option>
                        @endforeach
                    </flux:select>
                </flux:field>
