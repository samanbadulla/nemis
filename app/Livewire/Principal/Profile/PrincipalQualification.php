...
class PrincipalQualification extends Component
{
    ...
    public $principal; // Pass principal object to component
    ...
    public function save()
    {
        ...
        PeopleEducationQualification::create([
            'people_id' => $this->principal->people_id,
    ...
    {
        $qualificationList = PeopleEducationQualification::where('active_status', '1')->where('people_id', $this->principal->people_id)->get();
        return view('livewire.principal.profile.principal-qualification', compact('qualificationList'));
    }
}
