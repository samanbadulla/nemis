<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Sri lanka Teacher Adviseor service') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Manage SLTAS profile and account') }}
        </flux:subheading>
        ...
        <div class="my-6 flex items-center justify-end gap-3">
            ...
            <flux:modal.trigger name="search-profile">
                <flux:input as="button" placeholder="Search SLTAS..." icon="magnifying-glass" kbd="⌘K"
