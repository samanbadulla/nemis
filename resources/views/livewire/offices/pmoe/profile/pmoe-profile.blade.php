<section class="w-full">
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('PMOE Overview') }}</flux:heading>
        ...
        <div class="antialiased min-h-screen">
            ...
            <div class="max-w-5xl bg-white dark:bg-gray-800 p-6 rounded-b-lg">
                ...
                <div class="flex items-center space-x-4 mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                    <div
                        class="relative w-20 h-20 sm:w-24 sm:h-24 rounded-lg overflow-hidden border-2 {{ $provincialEducationMinistry->active_status ? 'border-green-500' : 'border-red-500' }}">

                        @if ($provincialEducationMinistry->logo)
                            <img src="{{ asset('storage/' . $provincialEducationMinistry->logo) }}"
                                alt="{{ $provincialEducationMinistry->name }}"
                                class="w-full h-full object-cover {{ $provincialEducationMinistry->active_status ? '' : 'grayscale opacity-60' }}">
                            @unless ($provincialEducationMinistry->active_status)
                                <div
                ...
                <div class="space-y-6">
                    ...
                    <section class="pt-4 border-t border-gray-200 dark:border-gray-700">
                        <p class="text-xs font-mono text-gray-500 dark:text-gray-600">
                            **System Key (Hash):** {{ $provincialEducationMinistry->id }}
                        </p>
                    </section>
